...
const photos = [
  { src: '/galerie/homme1.jpg', title: 'Dégradé Vagues (Waves)', desc: 'Coupe courte texturée avec dégradé progressif aux tempes.' },
  { src: '/galerie/homme2.jpg', title: 'Forfait Barbe & Coupe', desc: 'Sculpture complète de la barbe avec gommage de peau.' },
  { src: '/galerie/homme3.jpg', title: 'Dégradé à Blanc', desc: 'Coupe moderne très courte sur les côtés avec traçage précis.' },
  { src: '/galerie/homme4.jpg', title: 'Contours Dessinés', desc: 'Entretien des lignes de cheveux et finitions millimétrées.' },
  { src: '/galerie/homme5.jpg', title: 'Taille de Barbe Traditionnelle', desc: 'Rasage à l\'ancienne, serviette chaude et huiles essentielles.' },
  { src: '/galerie/homme6.jpg', title: 'Afro Court Dégradé', desc: 'Afro court structuré combiné avec un dégradé bas.' },
  { src: '/galerie/homme7.jpg', title: 'Contours & Coloration Barbe', desc: 'Soin de barbe densifiant et contours nets.' },
  { src: '/galerie/homme8.jpg', title: 'Coupe Slick Back Dégradé', desc: 'Style moderne lissé en arrière avec côtés dégradés.' },
  { src: '/galerie/homme9.jpg', title: 'Prestation Master Barbier', desc: 'Coupe VIP sculptée sur-mesure par Ibrahim.' }
];

export default function GalerieHomme() {
      ...
      <div>
        ...
        <section className="relative py-20 bg-charcoal text-white overflow-hidden mt-[73px]">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            >
              <span className="text-gold-light text-xs font-bold tracking-widest uppercase">Maître Barbier & Visagiste</span>
              <h1 className="text-4xl md:text-5xl font-serif font-bold mt-2">Galerie Hommes</h1>
              <p className="text-creme/80 text-sm md:text-base mt-4 max-w-xl leading-relaxed font-light">
                Consultez notre portfolio de coupes masculines, de tailles de barbe de précision et de soins visage purifiants.
              </p>
            </motion.div>
          </div>
        </section>
