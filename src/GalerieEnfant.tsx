...
const photos = [
  { src: '/galerie/enfant1.jpg', title: 'Tresses Fillette Créatives', desc: 'Tresses douces et colorées avec perles décoratives.' },
  { src: '/galerie/enfant2.jpg', title: 'Coupe Petit Gentleman', desc: 'Coupe courte classique propre et facile d\'entretien.' },
  { src: '/galerie/enfant3.jpg', title: 'Tresses Protectrices Enfant', desc: 'Nattes protectrices légères préservant le cuir chevelu.' },
  { src: '/galerie/enfant4.jpg', title: 'Coupe Garçon Moderne', desc: 'Petit dégradé moderne adapté pour les garçons.' },
  { src: '/galerie/enfant5.jpg', title: 'Nattes Fillette Simples', desc: 'Nattes à trois brins confortables pour l\'école.' },
  { src: '/galerie/enfant6.jpg', title: 'Soin Démêlant sans Douleur', desc: 'Hydratation et démêlage en douceur pour cheveux crépus.' }
];

export default function GalerieEnfant() {
      ...
      <div>
        ...
        <section className="relative py-20 bg-charcoal text-white overflow-hidden mt-[73px]">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            >
              <span className="text-gold-light text-xs font-bold tracking-widest uppercase">Jeunes Gentlemen & Princesses</span>
              <h1 className="text-4xl md:text-5xl font-serif font-bold mt-2">Galerie Enfants</h1>
              <p className="text-creme/80 text-sm md:text-base mt-4 max-w-xl leading-relaxed font-light">
                Découvrez nos styles pour enfants : des coupes et nattes douces, adaptées aux cheveux sensibles de vos tout-petits.
              </p>
            </motion.div>
          </div>
        </section>
